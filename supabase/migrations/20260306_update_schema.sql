-- 1. Adicionar campo de faturamento na tabela de médicos
ALTER TABLE public.doctors 
ADD COLUMN avg_consultation_price NUMERIC DEFAULT 350;

-- 2. Criar tabela de configurações de integração (WhatsApp/n8n)
...
-- 3. Habilitar RLS na integrations_config
...
-- 4. Criar trigger de atualização de timestamp
